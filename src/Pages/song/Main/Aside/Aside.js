    ...
    render(){
        return(
            ...
            <div className="user-component__column">
                ...
                <a href="#" className="user-component__id">soon.cake</a>
                <span className="user-component__subinfo">여주 떡케이크 순한설기</span
                >
                </div>
            </div>
            ...
            <span>회원님을 위한 추천</span><a href="#"><span>모두보기</span></a>
            </div>
            ...
            <div className="user-component">
                ...
                <div className="user-component__text">
                    <a href="" className="user-component__id">soon.cake</a>
                    <span className="user-component__subinfo"
                    >clematis_fleur님 외 1명이 팔로우합니다</span
                    >
                </div>
                </div>
                <button className="user-component__column btn-none">팔로우</button>
